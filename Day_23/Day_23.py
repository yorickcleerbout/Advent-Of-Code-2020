...
my_input = [int(i) for i in "219748365"]
...
print("What are the labels on the cups after cup 1? (Part 1):", part_one())
print("What do you get if you multiply their labels together? (Part 2):", part_two())
