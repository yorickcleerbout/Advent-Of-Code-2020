...
inputs = parse_input()
rules = rule_maker(inputs[0])


# Part One
print(f"How many messages completely match rule 0? (Part 1): {count_messages(rules, inputs[1])}")

# Part Two with diffrent Rules
rules[8] = [[42], [42, 8]]
rules[11] = [[42, 31], [42, 11, 31]]
print(f"After updating rules 8 and 11, how many messages completely match rule 0? (Part 2): {count_messages(rules, inputs[1])}")
